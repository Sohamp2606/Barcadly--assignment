...
export default function Form() {
  ...
  const validteData = () => {
    ...
    // point:  now assign all errors from newErros to error state
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      ...
      // point:  save data to local storage except password and confirmPassword
  ...
  // note:  Load form data from local storage when the component mounts
  useEffect(() => {
  ...
  // note:  Clear form data from local storage when the component unmounts
  useEffect(() => {
    updateFormDataInLocalStorage(formData);
  }, [formData]);

  const updateFormDataInLocalStorage = (updatedFormData) => {
